...
export const getSFLoginButton=`input[id="Login"]`;
export const getSFpasswordField=`input[name="pw"]`;
export const getSFUserNameField=`input[name="username"]`;
export const getLoginButton=`shadow/div[aria-label="Login"]`;
export const getSFButton=`[id="loginPage:j_id61"] #signup_or_signin_with_salesforce`;
